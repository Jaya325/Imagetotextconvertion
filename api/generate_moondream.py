...
def main():
    ...
    #option 1: Give the prompt from a JSON file
	...
	#option 2:Give the prompt manually hardcoded
	model = "moondream"
	prompt = "explain the image"
	url = "http://localhost:11434"
	image_inference = explain_image("C:\Users\LENOVO\Documents\lion.jpg", model, prompt, url)
